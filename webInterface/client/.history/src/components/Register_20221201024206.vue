<template>
    <div class="register">
        ...
        <el-form :model="Register_ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="register-ruleForm"
            label-position="right">
            <el-form-item label="Identity" prop="identity">
                <el-select v-model="identity" placeholder="Select your identity">
