<template>
    <div class="register">
        ...
        <el-form :model="Register_Form" :rules="rules" ref="ruleForm" label-width="100px" class="register-ruleForm"
            label-position="right">
            <el-form-item label="Identity" prop="identity">
                <el-select v-model="Register_Form.identity" placeholder="Select your identity">
