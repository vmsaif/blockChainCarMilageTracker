<template>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="register-ruleForm" label-position="right">
      ...
      <el-form-item label="Username" prop="name">
        ...
        <el-form-item label="special prove code" prop="code">
