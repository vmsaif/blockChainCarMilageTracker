<template>
    <div class="register">
        ...
        <el-form :model="registerPage" :rules="rules" ref="registerPage" label-width="100px" class="register-ruleForm"
            ...
            <el-form-item>
                <el-button type="primary" @click="submitForm('registerPage')">Register</el-button>
                <el-button @click="resetForm('registerPage')">Reset</el-button>
            </el-form-item> 
            <br>
