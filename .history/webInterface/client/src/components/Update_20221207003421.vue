<template>
    <div class="UpdateCar">
        ...
        <el-form :model="updateData" :rules="rules" ref="updateData" label-width="100px" class="updateCar_page" label-position="right">
            ...
            <el-form-item>
                <el-button type="primary" @click="submitForm('updateData')">Register</el-button>
...
export default {
    ...
    async registerCar() {
        alert(this.updateData.vin)
        const apiResponse = await PostsService.updateData(
            this.updateData.vin,
